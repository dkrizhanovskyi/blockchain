...
// TestHashSHA256Rust tests the SHA-256 hashing function implemented in Rust.
func TestHashSHA256Rust(t *testing.T) {
	...
	// Compute the hash using the Rust-based function.
...
// TestHashSHA512Rust tests the SHA-512 hashing function implemented in Rust.
func TestHashSHA512Rust(t *testing.T) {
	input := []byte("test data") // Sample input data.
